...
function Template2({ resumeRef, fillModeData }: TemplatesProps) {
	...
	return (
		<>
			<div
				ref={resumeRef}
				className="bg-primary min-h-screen relative pb-20 px-20">
				<section className="grid grid-cols-temp2One">
				...
				<section className="grid grid-col-temp2Two mb-5">
					<div className="text-white pt-4">
						<Objective
							level={2}
							headingClass="text-center mb-5 uppercase"
					...
					<div className="r5-second-block-col-3">
						<Education
							level={2}
							headClass="bg-white w-1/2 py-2.5 pr-4 pl-2.5 mb-5 uppercase"
							color="white"
							data={fillModeData ? fillModeData : apiData}
						/>
					</div>
				...
				<section className="grid grid-col-temp2Two mb-5">
					<div className="r5-second-block-col-1">
						<Activities
							headClass="r5-heading-col-1"
							level={2}
							hobbies={hobbies}
							textColor="var(--white)"
						/>
					</div>
					<div className="r5-second-block-col-2">
						<img src="mortarboard.png" alt="Qualification-Icon" />
